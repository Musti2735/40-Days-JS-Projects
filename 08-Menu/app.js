...
let domItems = document.querySelector('.section-center');

let breakfastMenu = menu.filter(function(item){
 return item.category=="breakfast";
});
let dinnerMenu = menu.filter(function(item){
  return item.category=="dinner";
 });
let shakesMenu = menu.filter(function(item){
  return item.category=="shakes";
 });
let lunchMenu = menu.filter(function(item){
...
breakfastBtn.addEventListener('click', function(){
  return showMenu(breakfastMenu)
});

lunchBtn.addEventListener('click', function(){
  return showMenu(lunchMenu)
})

shakesBtn.addEventListener('click', function(){
  return showMenu(shakesMenu)
})